...
//        //item name
        ...
        //quantity available
        TextView tv_itemAvbl = (TextView) view.findViewById(R.id.quantity_avbl);
        tv_itemAvbl.setText(chefMenu.getQuantity());

        //quantity ordered
        TextView tv_quantityOrdered = (TextView) view.findViewById(R.id.quantity_ordered);
        tv_quantityOrdered.setText(chefMenu.getqOrdered());
